## [**#**](https://daisyui.com/docs/layout-and-typography/#what-to-expect-from-here-on-out)接下来可以期待什么
...
### [**#**](https://daisyui.com/docs/layout-and-typography/#typography-should-be-easy)排版应该简单
...
## [**#**](https://daisyui.com/docs/layout-and-typography/#what-if-we-stack-headings)如果我们堆叠标题呢？

### [**#**](https://daisyui.com/docs/layout-and-typography/#we-should-make-sure-that-looks-good-too)我们也应该确保它看起来不错

有时你会有标题直接彼此堆叠在一起。在这些情况下，你通常必须撤销第二个标题的顶部边距，因为标题彼此之间更紧密通常看起来更好，而不是段落后跟着标题应该是的样子。

### [**#**](https://daisyui.com/docs/layout-and-typography/#when-a-heading-comes-after-a-paragraph-)当一个标题在段落之后……
...
## [**#**](https://daisyui.com/docs/layout-and-typography/#code-should-look-okay-by-default)代码默认应该看起来可以
...
### [**#**](https://daisyui.com/docs/layout-and-typography/#what-about-nested-lists)嵌套列表怎么样？
...
## [**#**](https://daisyui.com/docs/layout-and-typography/#there-are-other-elements-we-need-to-style)我们还需要样式化其他元素
...
### [**#**](https://daisyui.com/docs/layout-and-typography/#sometimes-i-even-use-code-in-headings)有时我甚至在标题中使用`代码`
...
#### [**#**](https://daisyui.com/docs/layout-and-typography/#we-havent-used-an-h4-yet)我们还没有使用`h4`
...
### [**#**](https://daisyui.com/docs/layout-and-typography/#we-still-need-to-think-about-stacked-headings-though)我们仍然需要考虑堆叠的标题

#### [**#**](https://daisyui.com/docs/layout-and-typography/#lets-make-sure-we-dont-screw-that-up-with-h4-elements-either)让我们确保我们不会在`h4`元素上搞砸那个
